...
> Status: `0.4.4`. Requires Pi `0.84.0` or newer and Node.js `22.19.0` or newer.
...
```bash
pi install git:github.com/baka-world/yimo-pi-kit@v0.4.4
```
...
```bash
pi install npm:yimo-pi-kit@0.4.4
```
